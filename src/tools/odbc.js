...
var Odbc = /** @class */ (function () {
    ...
    Odbc.prototype._init = function () {
        this._sequelize = new sequelize_1.Sequelize(process.env.DB_NAME || "priceradb25", process.env.DB_USER || "priceradmin", process.env.DB_PASSWORD || "MonMotDePasseSecurise123!", {
    ...
    Odbc.prototype.executeInTransaction = function (operation_1) {
        return __awaiter(this, arguments, void 0, function (operation, options) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.beginTransaction(options)];
                    case 1:
                        transaction = _a.sent();
                        _a.label = 2;
                    case 2:
        ...
        return __awaiter(this, arguments, void 0, function (table, length, guid, options) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 5: return [4 /*yield*/, this.generateGuid(table, length, guid + 1, options)];
    ...
    Odbc.initializeTables = function () {
        return __awaiter(this, arguments, void 0, function (models, options) {
            var tempInstance, sequelize, transaction, syncOptions, _i, models_1, model, error_15, rollbackError_1, closeError_1;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        console.log("\uD83D\uDCCB Synchronisation de ".concat(models.length, " mod\u00E8le(s)..."));
                    ...
                    case 5:
                        _a.sent();
                        console.log("\u2705 Table ".concat(model.tableName || model.name, " synchronis\u00E9e"));
                        return [3 /*break*/, 7];
                    case 6:
